	...
	$qiu=0;
		...
		if ($result['Str'] )
		{
		   ...
		   { 
				...
				$zz="h21";
				$sql = "UPDATE g_odds SET `{$zz}` = {$zz}-{$result['Str'][$i][2]} WHERE g_type ='{$result['Str'][$i][0]}' LIMIT 1 ";
				$this->db->query($sql, 2);
				
				//如果是大则降1-10 11-20将一半
				 
				$sql6 = "UPDATE g_odds SET `h1`=h1-{$qiu6},`h2`=h2-{$qiu6},`h3`=h3-{$qiu6},`h4`=h4-{$qiu6},`h5`=h5-{$qiu6},`h6`=h6-{$qiu6},`h7`=h7-{$qiu6},`h8`=h8-{$qiu6},`h9`=h9-{$qiu6},`h10`=h10-{$qiu6} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql6, 2);
				$sql = "UPDATE g_odds SET `h11`=h11-{$qiu},`h12`=h12-{$qiu},`h13`=h13-{$qiu},`h14`=h14-{$qiu},`h15`=h15-{$qiu},`h16`=h16-{$qiu},`h17`=h17-{$qiu},`h18`=h18-{$qiu},`h19`=h19-{$qiu},`h20`=h20-{$qiu} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql, 2);
				}
				...
				$this->db->query($sql, 2);
				//如果是小则降 11-20
				$sql6 = "UPDATE g_odds SET `h11`=h11-{$qiu6},`h12`=h12-{$qiu6},`h13`=h13-{$qiu6},`h14`=h14-{$qiu6},`h15`=h15-{$qiu6},`h16`=h16-{$qiu6},`h17`=h17-{$qiu6},`h18`=h18-{$qiu6},`h19`=h19-{$qiu6},`h20`=h20-{$qiu6} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql6, 2);
				$sql = "UPDATE g_odds SET `h1`=h1-{$qiu},`h2`=h2-{$qiu},`h3`=h3-{$qiu},`h4`=h4-{$qiu},`h5`=h5-{$qiu},`h6`=h6-{$qiu},`h7`=h7-{$qiu},`h8`=h8-{$qiu},`h9`=h9-{$qiu},`h10`=h10-{$qiu} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql, 2);
				}
				...
				$sql6 = "UPDATE g_odds SET `h1`=h1-{$qiu6},`h3`=h3-{$qiu6},`h5`=h5-{$qiu6},`h7`=h7-{$qiu6},`h9`=h9-{$qiu6},`h11`=h11-{$qiu6},`h13`=h13-{$qiu6},`h15`=h15-{$qiu6},`h17`=h17-{$qiu6},`h19`=h19-{$qiu6} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql6, 2);
				
				$sql = "UPDATE g_odds SET `h2`=h2-{$qiu},`h4`=h4-{$qiu},`h6`=h6-{$qiu},`h8`=h8-{$qiu},`h10`=h10-{$qiu},`h12`=h12-{$qiu},`h14`=h14-{$qiu},`h16`=h16-{$qiu},`h18`=h18-{$qiu},`h20`=h20-{$qiu} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql, 2);
				}
				...
				$sql6 = "UPDATE g_odds SET `h2`=h2-{$qiu6},`h4`=h4-{$qiu6},`h6`=h6-{$qiu6},`h8`=h8-{$qiu6},`h10`=h10-{$qiu6},`h12`=h12-{$qiu6},`h14`=h14-{$qiu6},`h16`=h16-{$qiu6},`h18`=h18-{$qiu6},`h20`=h20-{$qiu6} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql6, 2);
				
				$sql = "UPDATE g_odds SET `h1`=h1-{$qiu},`h3`=h3-{$qiu},`h5`=h5-{$qiu},`h7`=h7-{$qiu},`h9`=h9-{$qiu},`h11`=h11-{$qiu},`h13`=h13-{$qiu},`h15`=h15-{$qiu},`h17`=h17-{$qiu},`h19`=h19-{$qiu} WHERE g_type = 'Ball_{$result['Str'][$i][3]}'";
				//echo $sql;
				$this->db->query($sql, 2);
				//echo $sql;
				}
