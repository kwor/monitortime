...
class SumAmountnc 
{
	...
	private function Formula ()
	{
		...
		if ($numberList)
		{
			...
			{
				if (isString($resultList[$i]['g_mingxi_2']) && $resultList[$i]['g_result'] <=20)
				{
	...
	private function ResultCorrespond ($numberList, $resultList, $param=0)
	{
		...
		else if ($param == 1)
		{
			...
			else if ($resultList['g_mingxi_1'] == '任選二')
			{
				//任選二規則、8個中2個 視為中獎
...
//			}
			else if ($resultList['g_mingxi_1'] == '選二連組')
			{
			...
			else if ($resultList['g_mingxi_1'] == '任選三')
			{
				//任選二規則、8個中3個 視為中獎
...
//			}
			else if ($resultList['g_mingxi_1'] == '選三前組')
			{
			...
			else if ($resultList['g_mingxi_1'] == '任選四')
			{
				//任選四規則、8個中4個 視為中獎
			...
			else if ($resultList['g_mingxi_1'] == '任選五')
			{
				//任選五規則、8個中5個 視為中獎
	...
	private function SumLM ($numberList, $resultList, $count, $bool=true)
	{
		...
		{
			if ($nArray !=null && count($nArray) >=$count )
			{
