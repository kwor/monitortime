		...
		else if ($logId == 56)
		{
			...
			if ($a == 0){
				...
				if ($result['g_tueishui_3'] >0 )
					$List['g_tueishui'] = ((($result['g_tueishui_3'])/100) * $result['g_jiner']);
				else
					$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']);
			}else {
		...
		else if ($logId == 22)
		{
			...
			if ($a == 0){
				...
				if ($result['g_tueishui_2'] >0 )
					$List['g_tueishui'] = ((($result['g_tueishui_2'])/100) * $result['g_jiner']);
				else
					$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']);
			}else {
				$List['g_jiner'] =$result['g_jiner'] * ($a/100);
		...
		else if ($logId == 78)
		{
			...
			if ($a == 0){
				...
				if ($result['g_tueishui_1'] >0 )
					$List['g_tueishui'] = ((($result['g_tueishui_1'])/100) * $result['g_jiner']);
				else
					$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']);
			}else {
				$List['g_jiner'] =$result['g_jiner'] * ($a/100);
