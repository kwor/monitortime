...
//		dump($number);
	...
	private function SumPoshMoney($result, $results, $money)
	{
		...
		if ($results)
		{
			for ($n=0; $n<count($results); $n++)
			{
				...
				{
					$c = ((($results[$n]['g_tueishui']/100))*$results[$n]['g_jiner']);
	...
	private function SumReport($result, $logId)
	{
		...
		if ($logId == 89 )
		{
			$List['g_tueishui'] = ((($result['g_tueishui_4'])/100) * $result['g_jiner']) * ($result['g_distribution_4']/100);
		...
		else if ($logId == 56)
		{
			...
			if ($a == 0){
				...
				if ($result['g_tueishui_3'] >0 )
					$List['g_tueishui'] = ((($result['g_tueishui_3'])/100) * $result['g_jiner']) * ($a/100);
				else
					$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($a/100);
			}
		}
		else if ($logId == 22)
		{
			...
			if ($a == 0){
				...
				if ($result['g_tueishui_2'] >0 )
					$List['g_tueishui'] = ((($result['g_tueishui_2'])/100) * $result['g_jiner']) * ($a/100);
				else
					$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($a/100);
			}
		}
		else if ($logId == 78)
		{
			...
			if ($a == 0){
				...
				if ($result['g_tueishui_1'] >0 )
					$List['g_tueishui'] = ((($result['g_tueishui_1'])/100) * $result['g_jiner']) * ($a/100);
				else
					$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($a/100);
			}
		}
		else if ($logId == 48)
		{
			...
			if($a == 0){
				$p = (($result['g_tueishui'])/100) * $result['g_jiner'];
				$c = $result['g_jiner'];
			}else {
				$p = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($a/100);
	...
	private function SumReport($result, $logId)
	{
		...
		{
			$List['g_tueishui'] = ((($result['g_tueishui_3'])/100) * $result['g_jiner']) * ($result['g_distribution_3']/100);
			$List['g_jiner'] = $result['g_jiner'] * ($result['g_distribution_3']/100);
		}
		else if ($logId == 22)
		{
			if ($result['g_tueishui_2'] >0 )
				$List['g_tueishui'] = ((($result['g_tueishui_2'])/100) * $result['g_jiner']) * ($result['g_distribution_2']/100);
			else
				$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($result['g_distribution_2']/100);
			$List['g_jiner'] = $result['g_jiner'] * ($result['g_distribution_2']/100);
		}
		else if ($logId == 78)
		{
			if ($result['g_tueishui_1'] >0 )
				$List['g_tueishui'] = ((($result['g_tueishui_1'])/100) * $result['g_jiner']) * ($result['g_distribution_1']/100);
			else
				$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($result['g_distribution_1']/100);
			$List['g_jiner'] = $result['g_jiner'] * ($result['g_distribution_1']/100);
		}
		else if ($logId == 48)
		{
			$List['g_tueishui'] = ((($result['g_tueishui'])/100) * $result['g_jiner']) * ($result['g_distribution']/100);
