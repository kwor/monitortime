...
<title>Welcome</title>
<?php if (is_mobile() ) {
echo "<link href=\"css/login2.css\" rel=\"stylesheet\" type=\"text/css\" />";
	}else{
echo "<link href=\"css/login1.css\" rel=\"stylesheet\" type=\"text/css\" />";
}?>
...
<style type="text/css">
	...
	background:url(images/333.png) repeat;}
...
<div class="box">
	...
	<div class="boxBg"  id="Top_all">
       ...
       <img  id="ValidateImage"  align="bottom">
       </span>
       </li>
		</ul>
	<div class="clear"></div>
