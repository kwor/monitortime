...
//彩种分类0：六合彩，1：廣東快樂十分，2：重慶時時彩，3：北京賽車(PK10)，4：重慶幸運農場，5:江苏骰宝(江苏快3)
var  = new Array();
...
[5] = "<a href='javascript:void(0)' onclick='goto_CI(37,5,this.id)' id='MC38'>大小骰寶</a>";

[6] = "<a href='javascript:void(0)' onclick='goto_CI(39,6,this.id)' id='MC39'>總和、比數、五行</a><b>|</b><a href='javascript:void(0)' onclick='goto_CI(40,6,this.id)' id='MC40'>正碼</a>";
...
//T:获取数据的传递参数
//fid:类别（0：六合彩，1：廣東快樂十分，2：重慶時時彩，3：北京賽車(PK10)，4：重慶幸運農場，5:江苏骰宝/江苏快3）
