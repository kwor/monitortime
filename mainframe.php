    ...
    var _tem = ["<div class=\"clearfix\" id=\"bankLi-down\" style=\"display: none;\">",
					 ...
					 if($peizhicqssc=="1"){
			            echo "\"<li><a id=\\\"a2\\\"  uri=\\\"2\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(2)\\\">重慶時時彩</a></li>\"".",";
						 ...
						 if($peizhijxssc=="1"){
						echo "\"<li><a id=\\\"a8\\\"  uri=\\\"7\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(7)\\\">全天五分彩</a></li>\"".",";
						}
						 if($peizhixjssc=="1"){
						...
						echo "\"<li><a id=\\\"a12\\\"  uri=\\\"12\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(12)\\\">天津時時彩</a></li>\"".",";
						 ...
						 if($peizhipk10=="1"){
			           echo "\"<li><a id=\\\"a3\\\"  uri=\\\"3\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(3)\\\">北京賽車(PK10)</a></li>\"".",";
					   }
					    if($peizhinc=="1"){
						echo "\"<li style=\\\"border-bottom:none;\\\"><a id=\\\"a10\\\"  uri=\\\"10\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(10)\\\">重慶幸運農場</a></li>\"".",";
						}
					    if($peizhijsyxx=="1"){
                       echo "\"<li><a id=\\\"a4\\\"  uri=\\\"4\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(4)\\\">江苏鱼虾蟹</a></li>\"".",";
					   }
					    if($peizhijssz=="1"){
                       echo "\"<li><a id=\\\"a5\\\"  uri=\\\"5\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(5)\\\">江苏骰寶(快3)</a></li>\"".",";
					   }
					    if($peizhikl8=="1"){
                       echo "\"<li><a id=\\\"a6\\\"  uri=\\\"6\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(6)\\\">快樂8(雙盤)</a></li>\"".",";
					   }
					      if($peizhixyft=="1"){
						
						echo "\"<li><a id=\\\"a8\\\"  uri=\\\"8\\\" target=\\\"mainFrame\\\" onclick=\\\"onCK(8)\\\">幸運飛艇</a></li>\"".",";
						}
						?>
...
<frameset id="logOutForms" border="0" cols="*" frameborder="NO" framespacing="0" rows="89,*,0">
    ...
    <frameset border="0" cols="241,*" frameborder="NO" framespacing="0">
        ...
        <frame name="mainFrame" id="mainFrame" src="user/sGame_sm.php?g=g9" title="mainFrame" scrolling="auto">
    </frameset>
