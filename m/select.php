...
if ($peizhijxssc == "1") {
    ...
    echo " <option value=\"3\"  url=\"qtwfc_lm.php\" " . $jxssc . ">全天五分彩</option>";
}
if ($peizhixjssc == "1") {
...
if ($peizhijssz == "1") {
    ...
    echo "<option value=\"7\"  url=\"jsk3_lm.php\" " . $jstb . ">江苏骰寶</option>";
}
if ($peizhikl8 == "1") {
...
if ($peizhixyft == "1") {
    ...
    echo "<option value=\"4\"  url=\"XYFT_lm.php\" " . $xyft . ">幸运飞艇</option>";
}
