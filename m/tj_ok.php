...
<script type="text/javascript">
	...
	<div data-role="content" class="pm">		
        ...
        <div class="DDtitle" style=" text-align:center;">
			系統提示!
			<?php
			if($_SESSION['lm']=="d2"||$_SESSION['lm']=="d3"||$_SESSION['lm']=="d4"||$_SESSION['lm']=="d5"||$_SESSION['lm']=="d6"||$_SESSION['lm']=="d7"||$_SESSION['lm']=="d8")
			{
			...
			?>
			 <a href="<?=$game_type?>_<?=$SESSIONlm?>.php?_type=<?=$gameid?>&player_type=<?=$game_type2?>" data-transition="slide" data-direction="reverse"><div class="QDbtn">返回</div></a>
			</div>
			<div class="box">
