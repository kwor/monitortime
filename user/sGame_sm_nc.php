...
<table class="th" border="0" cellpadding="0" cellspacing="0">
	<tr>    	<td width="130" height="20" class="bolds">重慶幸運農場</td>
...
<table border="0" width="700" style="margin-top:10px;">
	<tr height="30">
	    	...
	    	<span id="Shortcut_DIV" class="font_g"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onclick="Shortcut_hidden();reset();" class="inputs ti" value="重&nbsp;填" />&nbsp;&nbsp;&nbsp;&nbsp;<input onclick = "submitforms()" type="button" id="submits" class="inputs ti" style="font-weight: bold;" value="下&nbsp;註" /><input type="text" id="submitss"  value="" style="width:0px;height:0px;border:0px;"/></td>
