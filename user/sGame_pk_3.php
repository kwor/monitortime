...
<table border="0" width="700">
	<tr height="30">
	    	...
	    	<span id="Shortcut_DIV" class="font_g"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input onclick="Shortcut_hidden();reset();" class="inputs ti" value="重&nbsp;填" type="button">&nbsp;&nbsp;&nbsp;&nbsp;<input onclick = "submitforms()" type="button"id="submits" class="inputs ti" value="下註" /><td width="0" class="actiionn"></td></td>	
