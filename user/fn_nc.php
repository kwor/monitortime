...
if ( strtotime($dateTime) < strtotime($stratGamenc) || strtotime($dateTime) > strtotime($endGamenc)){
...
$wan=$t;
         switch($wan){
			case 't1':$str='g1';break;
			case 't2':$str='g2';break;
			case 't3':$str='g3';break;
			case 't4':$str='g4';break;
			case 't5':$str='g5';break;
			case 't6':$str='g6';break;
			case 't7':$str='g7';break;
			case 't8':$str='g8';break;
			
			case '第一球':$str='g1';break;
			case '第二球':$str='g2';break;
			case '第三球':$str='g3';break;
			case '第四球':$str='g4';break;
			case '第五球':$str='g5';break;
			case '第六球':$str='g6';break;
			case '第七球':$str='g7';break;
			case '第八球':$str='g8';break;
			}
$t = gameTypeFormat($t);
...
if ($t=='總和、龍虎'){
	...
	$odds = setoddsnc($n, $odds, $ConfigModel, $user, 0,$str);
}
...
<form id="dp" action="" method="post">
    ...
    <input type="hidden" name="hid" value="<?php echo $_GET['n']?>" />
                    ...
                    <tr>
                        <td class="t_td_caption_1" width="27%">最高派彩</td>
                        <td class="t_td_text" width="70%" id="pc"><?php echo $ConfigModel['g_max_money']?></td>
                    </tr>
                    <tr>
                    	<td class="t_td_but" colspan="2" align="center">
                        	<input type="button" value="取&nbsp;消" onclick="location.href='left.php'" class="btn2" />&nbsp;&nbsp;
							<input name="confirm" class="btn2" style="font-weight: bold;" onmouseover="this.className='btn2m'" onmouseout="this.className='btn2'" type="submit" value="下&nbsp;註"/>
                        </td>
                    </tr>
                </table>
                </form>
