	...
	<table class="gridtable">
	  ...
	  <tr>
		...
		<div class="Rightbottom">
			<div class="left">
				<ul class="navOne-new">
					<li id="bankLi" name="bankLi" class="czBtn"><span id="currentType" onmouseover="onMenu();" onmouseout="onMenuOut()">廣東快樂十分</span>
					</li>
				</ul>
...
<!--<div class="navOne-newDown" id="tMenu" style="position:absolute; z-index:100;">
  <div class="clearfix" id="bankLi-down" style="top:30px;;display:none;">
    <ul>
      ...
      <li><a id="a3" target="mainFrame" onclick="onCK(6)">北京賽車(PK10)</a></li>
      <li><a id="a4" target="mainFrame" onclick="onCK(7)">江苏鱼虾蟹</a></li>
      <li><a id="a5" target="mainFrame" onclick="onCK(8)">江苏骰宝（快3）</a></li>
...
<script >                
/*function quit(url){
       art.dialog.confirm('您確定退出嗎？', function () {
            goto_URL('/user/' + url);
        }, function () {
            return;
        }); 
...
<li id="liBtn8" class="navBtn" onclick="quit('Quit.php')">安全退出</li>
