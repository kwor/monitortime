...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=700>
	<TBODY>
		<TR>
			<TD class=F_bold height=24 width="20%">江苏骰寶(快3)　　　</TD>
...
<FORM method=post name=M_JeuForm action=L_Confirm_Jeu.php target=leftFrame autocomplete="off" id="dp">
...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=700>
	<TBODY>
        ...
        <td align="center" >
	    	...
	    	<span id="Shortcut_DIV" class="font_g"></span>&nbsp;&nbsp;&nbsp;<input type="button" onClick="Shortcut_hidden();reset();eliminate_jeu();" class="inputs ti" value="重填" />&nbsp;&nbsp;&nbsp;&nbsp;<input onclick = "submitforms()" type="button" id="submits" class="inputs ti" name=confirm  value="下註" /><input type="text" id="submitss"  value="" style="width:0px;height:0px;border:0px;"/></td>
       			<td id="actiionn"></td>
		</TR>
	</TBODY>
</TABLE>
