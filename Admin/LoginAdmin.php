...
<?php if (is_mobile() ) {
echo "<link href=\"Admin/css/login2.css\" rel=\"stylesheet\" type=\"text/css\" />";
	}else{
echo "<link href=\"Admin/css/login.css\" rel=\"stylesheet\" type=\"text/css\" />";
}?>
...
<div class="box">
	...
	<div class="boxBg">
        ...
        <span class="code" id="code"><img   id="ValidateImage"  align="bottom"></span>
        </li>
		</ul>
	<div class="clear"></div>
	</div>
