...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['actions']) && isset($_GET['cid']))
{
	...
	if ($_GET['actions'] == 'add')
	{
		...
		//if (!Matchs::isString($_POST['s_panlus'], 1, 4))exit(back('请选择所属盘口！'));
		...
		if ($_GET['cid']==1 && $LoginId==89) //新增公司帳號
		{
			...
			$userList['g_panlus'] = $_POST['g_panlus'];	
			$userList['jishizhudan'] = $_POST['jishizhudan'];	
			$userList['zaixiantongji'] = $_POST['zaixiantongji'];
			$userList['duanxiaoxi'] = $_POST['duanxiaoxi'];
			$userList['touzhuguanli'] = $_POST['touzhuguanli'];
			$userList['lishirizhi'] = $_POST['lishirizhi'];
            ...
            <td class="c">
            	<table border="0" cellspacing="0" class="main">
				  ...
				  <tr style="height:28px">
								...
								{
								echo "即时注单：<input type=\"checkbox\" name=\"jishizhudan\">&nbsp; ";
								}
								if($Users[0]['zaixiantongji']=="on")
								{
								echo" 在线统计：<input type=\"checkbox\" name=\"zaixiantongji\">&nbsp; ";
								}
								if($Users[0]['duanxiaoxi']=="on")
								{
								echo"	短消息：<input type=\"checkbox\" name=\"duanxiaoxi\">&nbsp; ";
								}
								if($Users[0]['touzhuguanli']=="on")
								{
								echo"	投注管理：<input type=\"checkbox\" name=\"touzhuguanli\">&nbsp;";
								}if($Users[0]['lishirizhi']=="on")
								{
									echo"历史日志：<input type=\"checkbox\" name=\"lishirizhi\">&nbsp;";
								}
									...
									{
								echo	"即时注单：<input type=\"checkbox\" name=\"jishizhudan\">&nbsp; 
									在线统计：<input type=\"checkbox\" name=\"zaixiantongji\">&nbsp; 
									短消息：<input type=\"checkbox\" name=\"duanxiaoxi\">&nbsp; 
									投注管理：<input type=\"checkbox\" name=\"touzhuguanli\">&nbsp;
									历史日志：<input type=\"checkbox\" name=\"lishirizhi\">&nbsp;";
