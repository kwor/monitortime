...
function FromSubmit(){
		...
		if (sername.val() == ""){
		href = "dlzhudan.php?Type="+Find.val()+"&searchName="+searchne.val()+"&rid="+r.val()+"&start="+s.val()+"&end="+e.val()+"&gname=";
		}else{
		href = "dlzhudan.php?Type="+Find.val()+"&searchName=&rid="+r.val()+"&start="+s.val()+"&end="+e.val()+"&gname="+sername.val();
		}
	location.href = href;
}
