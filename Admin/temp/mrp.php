          ...
          <tr >
            ...
            <td class="c"><!-- strat -->
              ...
              <table border="0" cellspacing="0" class="conter">
                <tr class="tr_top" >
                  <th><?php  if($peizhigdklsf=="1"){ echo "廣東快樂十分";}  if($peizhinc=="1"){ echo "重慶幸運農場";}?></th>
                  <th><?php if($peizhicqssc=="1"){echo "重慶時時彩 ";}  if($peizhijxssc=="1"){ echo "全天五分彩 ";}  if($peizhixjssc=="1"){ echo "新疆時時彩 ";}  if($peizhitjssc=="1"){ echo "天津时时彩 ";}?></th>
                </tr>
                <tr>
                ...
                <tr class="tr_top">
                  <th><?php if($peizhipk10=="1"){ echo "北京賽車(PK10) ";}  if($peizhixyft=="1"){ echo "幸運飛艇 ";}?></th>
                  <th><?php  if($peizhijssz=="1"){ echo "江苏骰寶(快3) ";}  if($peizhijsyxx=="1"){ echo "江苏鱼虾蟹 ";}?></th>
                </tr>
                <tr>
                  <td><table border="0" cellspacing="0" width="100%" class="conter">
                      <tr class="tr_top">
                ...
                <tr class="tr_top">
                  <th><?php  if($peizhikl8=="1"){ echo "快樂8(雙盤)";}?></th>
                  <th></th>
                </tr>
                <tr>
                  <td><table border="0" cellspacing="0" width="100%" class="conter">
