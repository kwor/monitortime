...
//写入连续值判断不能小于2
	if ($_POST['up_odds_mix_cq']<2) exit(back('重庆时时彩連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix_jx']<2) exit(back('全天五分彩連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix_tj']<2) exit(back('天津时时彩連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix_xj']<2) exit(back('新疆时时彩連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix_pk']<2) exit(back('北京賽車(PK10)連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix']<2) exit(back('广东快乐十分連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix_nc']<2) exit(back('幸运农场連續值輸入錯誤，不能小于2.'));
	if ($_POST['up_odds_mix_xyft']<2) exit(back('幸運飛艇連續值輸入錯誤，不能小于2.'));
	$List = array();
	for ($i=1; $i<=10; $i++){
		...
		if ($i<=7)
			$List['g_game_jx_'.$i.''] = empty($_POST['game_jx_'.$i.'']) ? 0 : $_POST['game_jx_'.$i.''];	
		if ($i<=7)
			$List['g_game_tj_'.$i.''] = empty($_POST['game_tj_'.$i.'']) ? 0 : $_POST['game_tj_'.$i.''];	
		if ($i<=7)
	...
	$List['g_up_odds_mix_jx'] = $_POST['up_odds_mix_jx'];
	$List['g_odds_num_jx'] = $_POST['odds_num_jx'];
	$List['g_odds_str_jx'] = $_POST['odds_str_jx'];
	$List['g_up_odds_mix_xj'] = $_POST['up_odds_mix_xj'];
	$List['g_odds_num_xj'] = $_POST['odds_num_xj'];
	$List['g_odds_str_xj'] = $_POST['odds_str_xj'];
	$List['g_up_odds_mix_tj'] = $_POST['up_odds_mix_tj'];
	$List['g_odds_num_tj'] = $_POST['odds_num_tj'];
	$List['g_odds_str_tj'] = $_POST['odds_str_tj'];
	...
	g_game_jxssc_1='{$List['g_game_jx_1']}',
	g_game_jxssc_2='{$List['g_game_jx_2']}',
	g_game_jxssc_3='{$List['g_game_jx_3']}',
	g_game_jxssc_4='{$List['g_game_jx_4']}',
	g_game_jxssc_5='{$List['g_game_jx_5']}',
	g_game_jxssc_6='{$List['g_game_jx_6']}',
	g_game_jxssc_7='{$List['g_game_jx_7']}',
	g_up_odds_mix_jxssc='{$List['g_up_odds_mix_jx']}',
	g_odds_num_jxssc='{$List['g_odds_num_jx']}',
	g_odds_str_jxssc='{$List['g_odds_str_jx']}',
	
	g_game_xjssc_1='{$List['g_game_xj_1']}',
	g_game_xjssc_2='{$List['g_game_xj_2']}',
	g_game_xjssc_3='{$List['g_game_xj_3']}',
	g_game_xjssc_4='{$List['g_game_xj_4']}',
	g_game_xjssc_5='{$List['g_game_xj_5']}',
	g_game_xjssc_6='{$List['g_game_xj_6']}',
	g_game_xjssc_7='{$List['g_game_xj_7']}',
	g_up_odds_mix_xjssc='{$List['g_up_odds_mix_xj']}',
	g_odds_num_xjssc='{$List['g_odds_num_xj']}',
	g_odds_str_xjssc='{$List['g_odds_str_xj']}',
	
	g_game_tjssc_1='{$List['g_game_tj_1']}',
	g_game_tjssc_2='{$List['g_game_tj_2']}',
	g_game_tjssc_3='{$List['g_game_tj_3']}',
	g_game_tjssc_4='{$List['g_game_tj_4']}',
	g_game_tjssc_5='{$List['g_game_tj_5']}',
	g_game_tjssc_6='{$List['g_game_tj_6']}',
	g_game_tjssc_7='{$List['g_game_tj_7']}',
	g_up_odds_mix_tjssc='{$List['g_up_odds_mix_tj']}',
	g_odds_num_tjssc='{$List['g_odds_num_tj']}',
	g_odds_str_tjssc='{$List['g_odds_str_tj']}',
	...
	sscnandu='{$_POST['sscnandu']}',
	sscjingque='{$_POST['sscjingque']}',
	ssczhanghao='{$_POST['ssczhanghao']}',
      ...
      <table border="0" cellspacing="0" class="main">
        ...
        <table border="0" cellspacing="0" class="conter">
          ...
          <tr style="height:38px;<?php  if($peizhigdklsf!="1"){ echo "display:none;";}?>">
            ...
            <td class="left_p6"> 開啟&nbsp;
              ...
              &nbsp;&nbsp; <span class="red">（此項關閉后，只自動開盤，广东不会采集开奖数据）</span></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhicqssc!="1"){ echo "display:none;";}?>">
            ...
            <td class="left_p6"> 開啟&nbsp;
              ...
              &nbsp;&nbsp; <span class="red">（此項關閉后，只自動開盤，重庆不会采集开奖数据）</span></td>
          </tr>
            <tr style="height:38px;<?php  if($peizhijxssc!="1"){ echo "display:none;";}?>">
            <td class="bj">五分彩自動開獎:</td>
            <td class="left_p6"> 開啟&nbsp;
          ...
          <tr style="height:38px;<?php  if($peizhipk10!="1"){ echo "display:none;";}?>">
            ...
            <td class="left_p6"> 開啟&nbsp;
              ...
              &nbsp;&nbsp; <span class="red">（此項關閉后，只自動開盤，北京PK10不会采集开奖数据）</span></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhixyft!="1"){ echo "display:none;";}?>">
            <td class="bj">幸運飛艇自動開獎:</td>
            <td class="left_p6"> 開啟&nbsp;
              ...
              &nbsp;&nbsp; <span class="red">（此項關閉后，只自動開盤，不采集）</span></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhijssz!="1"){ echo "display:none;";}?>">
            <td class="bj">江苏快3自動開獎:</td>
            <td class="left_p6"> 開啟&nbsp;
              ...
              &nbsp;&nbsp; <span class="red">（此項關閉后，只自動開盤，江苏快3不会采集开奖数据）</span></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhikl8!="1"){ echo "display:none;";}?>">
            <td class="bj">快樂8(雙盤)自動開獎:</td>
            <td class="left_p6"> 開啟&nbsp;
              ...
              &nbsp;&nbsp; <span class="red">（此項關閉后，只自動開盤，快樂8(雙盤)不会采集开奖数据）</span></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhinc!="1"){ echo "display:none;";}?>">
            <td class="bj">重慶幸運農場自動開獎:</td>
            <td class="left_p6"> 開啟&nbsp;
        ...
        <table border="0" cellspacing="0" class="conter">
          ...
          <tr style="height:38px;<?php  if($peizhicqssc!="1"){ echo "display:none;";}?>">
		   ...
		   <tr style="height:38px;<?php  if($peizhijxssc!="1"){ echo "display:none;";}?>">
            <td class="bj"><b>全天五分彩:</b></td>
            <td class="left_p6"> 第一球&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_1']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_1" value="1" />
              &nbsp;&nbsp;
              第二球&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_2']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_2" value="1" />
              &nbsp;&nbsp;
              第三球&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_3']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_3" value="1" />
              &nbsp;&nbsp;
              第四球&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_4']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_4" value="1" />
              &nbsp;&nbsp;
              第五球&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_5']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_5" value="1" />
              &nbsp;&nbsp;
              總分龍虎&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_6']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_6" value="1" />
              &nbsp;&nbsp;
              前三、中三、后三&nbsp;
              <input <?php if($ConfigModel['g_game_jxssc_7']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_7" value="1" />
              &nbsp;&nbsp; </td>
          </tr>
          <tr style="height:38px; display:none">
            <td class="bj">B盤:</td>
            <td class="left_p6"> 1-5號碼:&nbsp;
              <input type="text" class="textc" name="odds_ratio_jx_b1" value="<?php echo $ConfigModel['g_odds_ratio_jxssc_b1']?>" />
              &nbsp;
              兩面:&nbsp;
              <input type="text" class="textc" name="odds_ratio_jx_b2" value="<?php echo $ConfigModel['g_odds_ratio_jxssc_b2']?>" />
              &nbsp;&nbsp;
              前三、中三、后三:&nbsp;
              <input type="text" class="textc" name="odds_ratio_jx_b3" value="<?php echo $ConfigModel['g_odds_ratio_jxssc_b3']?>" /></td>
          </tr>
          <tr style="height:38px; display:none">
            <td class="bj">C盤:</td>
            <td class="left_p6"> 1-5號碼:&nbsp;
              <input type="text" class="textc" name="odds_ratio_jx_c1" value="<?php echo $ConfigModel['g_odds_ratio_jxssc_c1']?>" />
              &nbsp;
              兩面:&nbsp;
              <input type="text" class="textc" name="odds_ratio_jx_c2" value="<?php echo $ConfigModel['g_odds_ratio_jxssc_c2']?>" />
              &nbsp;&nbsp;
              前三、中三、后三:&nbsp;
              <input type="text" class="textc" name="odds_ratio_jx_c3" value="<?php echo $ConfigModel['g_odds_ratio_jxssc_c3']?>" /></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhijxssc!="1"){ echo "display:none;";}?>">
            <td class="bj">動態賠率:</td>
            <td class="left_p6"> 連續值&nbsp;
              <input class="textc" style="width:50px" type="text" name="up_odds_mix_jx" value="<?php echo $ConfigModel['g_up_odds_mix_jxssc']?>" />
              &nbsp;&nbsp;
              1-5球總值&nbsp;
              <input class="textc" style="width:50px" type="text" name="odds_num_jx" value="<?php echo $ConfigModel['g_odds_num_jxssc']?>" />
              &nbsp;&nbsp;
              雙面總值&nbsp;
              <input class="textc" style="width:50px" type="text" name="odds_str_jx" value="<?php echo $ConfigModel['g_odds_str_jxssc']?>" />
              &nbsp;&nbsp; <span class="odds">(超出連續值以設置的總值累加，執行賠率變動。)</span></td>
          </tr>
		  
		  
		  <tr style="height:38px;<?php  if($peizhitjssc!="1"){ echo "display:none;";}?>">
            <td class="bj"><b>天津時時彩:</b></td>
             <td class="left_p6"> 第一球&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_1']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_1" value="1" />
              &nbsp;&nbsp;
              第二球&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_2']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_2" value="1" />
              &nbsp;&nbsp;
              第三球&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_3']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_3" value="1" />
              &nbsp;&nbsp;
              第四球&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_4']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_4" value="1" />
              &nbsp;&nbsp;
              第五球&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_5']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_5" value="1" />
              &nbsp;&nbsp;
              總分龍虎&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_6']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_6" value="1" />
              &nbsp;&nbsp;
              前三、中三、后三&nbsp;
              <input <?php if($ConfigModel['g_game_tjssc_7']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_tj_7" value="1" />
              &nbsp;&nbsp; </td>
          </tr>
          <tr style="height:38px; display:none">
            <td class="bj">B盤:</td>
            <td class="left_p6"> 1-5號碼:&nbsp;
              <input type="text" class="textc" name="odds_ratio_tj_b1" value="<?php echo $ConfigModel['g_odds_ratio_tjssc_b1']?>" />
              &nbsp;
              兩面:&nbsp;
              <input type="text" class="textc" name="odds_ratio_tj_b2" value="<?php echo $ConfigModel['g_odds_ratio_tjssc_b2']?>" />
              &nbsp;&nbsp;
              前三、中三、后三:&nbsp;
              <input type="text" class="textc" name="odds_ratio_tj_b3" value="<?php echo $ConfigModel['g_odds_ratio_tjssc_b3']?>" /></td>
          </tr>
          <tr style="height:38px; display:none">
            <td class="bj">C盤:</td>
            <td class="left_p6"> 1-5號碼:&nbsp;
              <input type="text" class="textc" name="odds_ratio_tj_c1" value="<?php echo $ConfigModel['g_odds_ratio_tjssc_c1']?>" />
              &nbsp;
              兩面:&nbsp;
              <input type="text" class="textc" name="odds_ratio_tj_c2" value="<?php echo $ConfigModel['g_odds_ratio_tjssc_c2']?>" />
              &nbsp;&nbsp;
              前三、中三、后三:&nbsp;
              <input type="text" class="textc" name="odds_ratio_tj_c3" value="<?php echo $ConfigModel['g_odds_ratio_tjssc_c3']?>" /></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhitjssc!="1"){ echo "display:none;";}?>">
            <td class="bj">動態賠率:</td>
            <td class="left_p6"> 連續值&nbsp;
              <input class="textc" style="width:50px" type="text" name="up_odds_mix_tj" value="<?php echo $ConfigModel['g_up_odds_mix_tjssc']?>" />
              &nbsp;&nbsp;
              1-5球總值&nbsp;
              <input class="textc" style="width:50px" type="text" name="odds_num_tj" value="<?php echo $ConfigModel['g_odds_num_tjssc']?>" />
              &nbsp;&nbsp;
              雙面總值&nbsp;
              <input class="textc" style="width:50px" type="text" name="odds_str_tj" value="<?php echo $ConfigModel['g_odds_str_tjssc']?>" />
              &nbsp;&nbsp; <span class="odds">(超出連續值以設置的總值累加，執行賠率變動。)</span></td>
          </tr>
		  ...
		  <tr style="height:38px;<?php  if($peizhixjssc!="1"){ echo "display:none;";}?>">
            ...
            <td class="left_p6"> 第一球&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_1']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_1" value="1" />
              &nbsp;&nbsp;
              第二球&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_2']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_2" value="1" />
              &nbsp;&nbsp;
              第三球&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_3']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_3" value="1" />
              &nbsp;&nbsp;
              第四球&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_4']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_4" value="1" />
              &nbsp;&nbsp;
              第五球&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_5']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_5" value="1" />
              &nbsp;&nbsp;
              總分龍虎&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_6']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_6" value="1" />
              &nbsp;&nbsp;
              前三、中三、后三&nbsp;
              <input <?php if($ConfigModel['g_game_xjssc_7']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_xj_7" value="1" />
              &nbsp;&nbsp; </td>
          </tr>
          <tr style="height:38px; display:none">
            <td class="bj">B盤:</td>
            <td class="left_p6"> 1-5號碼:&nbsp;
              <input type="text" class="textc" name="odds_ratio_xj_b1" value="<?php echo $ConfigModel['g_odds_ratio_xjssc_b1']?>" />
              &nbsp;
              兩面:&nbsp;
              <input type="text" class="textc" name="odds_ratio_xj_b2" value="<?php echo $ConfigModel['g_odds_ratio_xjssc_b2']?>" />
              &nbsp;&nbsp;
              前三、中三、后三:&nbsp;
              <input type="text" class="textc" name="odds_ratio_xj_b3" value="<?php echo $ConfigModel['g_odds_ratio_xjssc_b3']?>" /></td>
          </tr>
          <tr style="height:38px; display:none">
            <td class="bj">C盤:</td>
            <td class="left_p6"> 1-5號碼:&nbsp;
              <input type="text" class="textc" name="odds_ratio_xj_c1" value="<?php echo $ConfigModel['g_odds_ratio_xjssc_c1']?>" />
              &nbsp;
              兩面:&nbsp;
              <input type="text" class="textc" name="odds_ratio_xj_c2" value="<?php echo $ConfigModel['g_odds_ratio_xjssc_c2']?>" />
              &nbsp;&nbsp;
              前三、中三、后三:&nbsp;
              <input type="text" class="textc" name="odds_ratio_xj_c3" value="<?php echo $ConfigModel['g_odds_ratio_xjssc_c3']?>" /></td>
          </tr>
          <tr style="height:38px;<?php  if($peizhixjssc!="1"){ echo "display:none;";}?>">
            <td class="bj">動態賠率:</td>
            <td class="left_p6"> 連續值&nbsp;
              <input class="textc" style="width:50px" type="text" name="up_odds_mix_xj" value="<?php echo $ConfigModel['g_up_odds_mix_xjssc']?>" />
              &nbsp;&nbsp;
              1-5球總值&nbsp;
              <input class="textc" style="width:50px" type="text" name="odds_num_xj" value="<?php echo $ConfigModel['g_odds_num_xjssc']?>" />
              &nbsp;&nbsp;
              雙面總值&nbsp;
              <input class="textc" style="width:50px" type="text" name="odds_str_xj" value="<?php echo $ConfigModel['g_odds_str_xjssc']?>" />
              &nbsp;&nbsp; <span class="odds">(超出連續值以設置的總值累加，執行賠率變動。)</span></td>
          </tr>
		  
		  
          <tr style="height:38px;<?php  if($peizhipk10!="1"){ echo "display:none;";}?>">
            <td class="bj"><b>北京賽車(PK10):</b></td>
		...
		<table border="0" cellspacing="0" class="conter" style="<?php  if($peizhijxssc!="1"){ echo "display:none;";}?>">
          <tr class="tr_top">
            <th colspan="2">全天五分彩設置</th>
          </tr>
          
		  
		  <tr style="height:38px">
            <td class="bj"><b>难度设置:</b></td>
            <td class="left_p6">   <input class="textc" style="width:50px" type="text" name="sscnandu" value="<?php echo $ConfigModel['sscnandu']?>" />
              &nbsp;&nbsp; <span class="odds">(0按照循环内赢最多开出，1按照赢随机开出 ，2按照随机开出   其他将按照输入的值以上赢 一般用于少输作用 让会员赢点 比如-1000。)</span>
              </td>
          </tr>
		  <tr style="height:38px">
            <td class="bj"><b>精确设置:</b></td>
            <td class="left_p6">   <input class="textc" style="width:50px" type="text" name="sscjingque" value="<?php echo $ConfigModel['sscjingque']?>" />
              &nbsp;&nbsp; <span class="odds">(请输入300以上的数字。[随机出多少组号码筛选,设置不要高于5000])</span>
              </td>
          </tr>
		  <tr style="height:38px">
            <td class="bj"><b>不计算内帐号设置:</b></td>
            <td class="left_p6">   <input class="textc" style="width:350px" type="text" name="ssczhanghao" value="<?php echo $ConfigModel['ssczhanghao']?>" />
              &nbsp;&nbsp; <span class="odds">(此内帐号将不在计算范围。[格式： (aa5700|aa800|aa900)])</span>
              </td>
          </tr>
        </table>
        <!-- end -->
