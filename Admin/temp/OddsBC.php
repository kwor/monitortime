                  ...
                  echo "<option style=\"color:Blue\" value=\"1\" ".$arr_slt[1].">廣東快樂十分</option>";
				   ...
				   if($peizhicqssc=="1"){
                    echo "<option style=\"color:Blue\" value=\"2\" ".$arr_slt[2].">重慶時時彩</option>";
					 ...
					 if($peizhijxssc=="1"){
                    echo "<option style=\"color:Blue\" value=\"3\" ".$arr_slt[3].">全天五分彩</option>";
					}
					 if($peizhixjssc=="1"){
	                ...
	                echo "<option style=\"color:Blue\" value=\"11\" ".$arr_slt[11].">天津时时彩</option>";
					 ...
					 if($peizhipk10=="1"){
                    echo "<option style=\"color:Blue\" value=\"6\" ".$arr_slt[6].">北京賽車(PK10)</option>";
					}
					 if($peizhixyft=="1"){
                     echo "<option style=\"color:Blue\" value=\"4\" ".$arr_slt[4].">幸運飛艇</option>";
					 }
					  if($peizhijssz=="1"){
                      echo "<option style=\"color:Blue\" value=\"7\" ".$arr_slt[7].">江苏骰寶(快3)</option>";
					  }
					   if($peizhikl8=="1"){
                      echo "<option style=\"color:Blue\" value=\"8\" ".$arr_slt[8].">快樂8(雙盤)</option>";
					  }
					   if($peizhinc=="1"){
                      echo "<option style=\"color:Blue\" value=\"9\" ".$arr_slt[9].">重慶幸運農場</option>";
					  }
					  ?>
                    </select></td>
                </tr>
