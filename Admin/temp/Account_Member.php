...
{
    if (!isset($_POST['s_leixing'])) exit(back('请选择会员所属额度类型！'));
...
<script type="text/javascript">
function process(menuObj){
var i= menuObj.selectedIndex;
if (i>0)
{
<!--	alert(menuObj.options[i].value);
//-->
 document.getElementById("label1").innerHTML="现金额度-金额不返还";
}else{
 document.getElementById("label1").innerHTML="信用额度-金额每天返还";
}
}
</script>
</head>
                    ...
                    <tr>
                        ...
                        <!-- strat -->
                             <table border="0" cellspacing="0" class="conter">
								...
								<tr style="height:28px">
								<td class="bj" id="bj">额度类型</td>
								<td class="left_p5" style="color:#0000FF">
								<select name="s_leixing" onChange="process(this)">
								<option value="0">信用额度-金额每天返还</option>
								<option value="1">现金额度-金额不返还</option>
								</select> 
								</td>
								</tr>
                                <tr style="height:28px">
                                	<td class="bj" id="label1">信用额度-金额每天返还</td>
