...
<!--
	function selects($this){
		location.href = "_Result.php?id="+$this.value;
	}
	...
	function onSelect(v){
		...
		if(v==1){sel.selectedIndex=0;location.href = "/admin/temp/_Result.php?id=1"};
		if(v==2){sel.selectedIndex=1;location.href = "/admin/temp/_Result.php?id=2"};
		if(v==3){sel.selectedIndex=2;location.href = "/admin/temp/_Result.php?id=6"};
		if(v==4){sel.selectedIndex=3;location.href = "/admin/temp/_Result.php?id=7"};
		if(v==5){sel.selectedIndex=3;location.href = "/admin/temp/_Result.php?id=7"};
		if(v==6){sel.selectedIndex=4;location.href = "/admin/temp/_Result.php?id=8"};
...
if ($peizhinc == "1") {
    ...
    echo "  <option " . $lie9 . "  value=\"9\">重慶幸運農場</option>";
        ...
        <td><?php echo $numberList[$i][2].":00"?></td>
